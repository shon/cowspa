...
web build:
 - http://mootools.net/core/688cc122080c13d7e4f9bd83baf5082f

packager build:
 - packager build Core/Core Core/Array Core/Object Core/Event Core/Class Core/Class.Extras Core/Element Core/Element.Style Core/Element.Dimensions Core/Fx.Tween Core/Fx.Morph Core/Fx.Transitions Core/Request.HTML Core/Request.JSON Core/Cookie Core/JSON Core/DOMReady
...
var $pick=function(){return Array.from(arguments).pick();};Object.extend({subset:function(c,f){var e={};for(var d=0,a=f.length;d<a;d++){var b=f[d];e[b]=c[b];
}return e;},map:function(a,d,e){var c={};for(var b in a){if(a.hasOwnProperty(b)){c[b]=d.call(e,a[b],b,a);}}return c;},filter:function(a,c,d){var b={};Object.each(a,function(f,e){if(c.call(d,f,e,a)){b[e]=f;
...
},toQueryString:function(a){return Object.toQueryString(this,a);}});Hash.extend=Object.append;Hash.alias({indexOf:"keyOf",contains:"hasValue"});Function.extend({attempt:function(){for(var b=0,a=arguments.length;
...
};(function(){Element.Properties.events={set:function(c){this.addEvents(c);}};[Element,Window,Document].invoke("implement",{addEvent:function(g,i){var j=this.retrieve("events",{});
